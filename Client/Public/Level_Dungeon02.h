...
class CLevel_Dungeon02 final : public CLevel
{
private:
	CLevel_Dungeon02(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CLevel_Dungeon02() = default;
...
public:
	static CLevel_Dungeon02* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
