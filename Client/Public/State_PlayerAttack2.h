...
BEGIN(Client)
class CState_PlayerAttack2 final : public CState
{
private:
	CState_PlayerAttack2(class CFsm* pFsm);
	virtual ~CState_PlayerAttack2() = default;
...
public:
	static CState_PlayerAttack2* Create(class CFsm* pFsm,_uint iStateNum);
