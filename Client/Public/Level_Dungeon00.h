...
class CLevel_Dungeon00 final : public CLevel
{
private:
	CLevel_Dungeon00(LPDIRECT3DDEVICE9 pGraphic_Device);
	virtual ~CLevel_Dungeon00() = default;
...
private:
	...
	_bool m_isLoaded[5] = { false, false, false, false, false };	//처음에만 로드 될 애들
...
public:
	static CLevel_Dungeon00* Create(LPDIRECT3DDEVICE9 pGraphic_Device);
