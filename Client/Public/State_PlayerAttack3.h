...
BEGIN(Client)
class CState_PlayerAttack3 final : public CState
{
private:
	CState_PlayerAttack3(class CFsm* pFsm);
	virtual ~CState_PlayerAttack3() = default;
...
public:
	static CState_PlayerAttack3* Create(class CFsm* pFsm, _uint iStateNum);
