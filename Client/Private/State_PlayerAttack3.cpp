...
CState_PlayerAttack3::CState_PlayerAttack3(class CFsm* pFsm)
    :CState(pFsm)
{
}

HRESULT CState_PlayerAttack3::Initialize(_uint iStateNum)
{
    m_iStateNum = iStateNum;
    return S_OK;
}

HRESULT CState_PlayerAttack3::Start_State()
{
    m_pPlayer = static_cast<CPlayer*>(m_pFsm->Get_Owner());
    // Safe_AddRef(m_pPlayer);
    m_pPlayer->Change_Animation(TEXT("Attack3"));
    m_pPlayer->Set_Player_State(CPlayer::ATTACK3);
...
void CState_PlayerAttack3::Update(_float fTimeDelta)
{
...
void CState_PlayerAttack3::End_State()
{
}

void CState_PlayerAttack3::Check_Move()
{
...
void CState_PlayerAttack3::Check_Mouse()
{
...
CState_PlayerAttack3* CState_PlayerAttack3::Create(class CFsm* pFsm,_uint iStateNum)
{
    CState_PlayerAttack3* pInstance = new CState_PlayerAttack3(pFsm);
...
void CState_PlayerAttack3::Free()
{
    __super::Free();
}
